...
import { Circle, Video, WebcamIcon } from "lucide-react";
...
import { saveAnswerAction, updateInterviewStatusAction, generateFeedbackAction } from "@/app/actions";
...
export default function StartClient() {
    ...
    useEffect(() => {
        if (!pendingSubmit || isRecording) return;

        const timer = setTimeout(() => {
            const combinedAnswer = userAnswer.trim();
    ...
    }, [pendingSubmit, isRecording, userAnswer, interviewId, interviewQuestion, interviewQuestionAnswers, activeQ, savedAnswerIds]);
